        ...
        <ul>
          <li className={`nav-item ${isActive("/home")}`}>
            <Link href="/" passHref>
              ...
              {isSidebarExpanded && <span className="nav-text">Home</span>}
            </Link>
          </li>
          ...
          <li className={`nav-item ${isActive("/favorites")}`}>
            <Link href="/favorites" passHref>
              ...
              {isSidebarExpanded && <span className="nav-text">Favorites</span>}
            </Link>
          </li>
          ...
          <li className={`nav-item ${isActive("/watch-later")}`}>
            <Link href="/watch-later" passHref>
              ...
              {isSidebarExpanded && <span className="nav-text">Watch Later</span>}
            </Link>
          </li>
        </ul>
        {isSidebarExpanded && (
